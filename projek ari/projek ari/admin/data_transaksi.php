<?php 
include '../koneksi.php'; // pastikan koneksi tersedia di $conn

$query = mysqli_query($conn, "SELECT * FROM view_data_transaksi");
?>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <p><strong>Nama Pelanggan:</strong> <?= $row['nama_pelanggan'] ?></p>
