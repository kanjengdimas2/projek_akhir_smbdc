        ...
        <div class="sidebar-wrapper scrollbar scrollbar-inner">
          <div class="sidebar-content">
            <ul class="nav nav-secondary">
              ...
              <li class="nav-item">
                <a href="data-produk-terjual">
                  <i class="fas fa-book"></i>
                  <p>Data Produk Terjual</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="data-log-update-harga">
                  <i class="fas fa-book"></i>
                  <p>data_log_update_harga </p>
                </a>
              </li>
              <li class="nav-item">
                <a href="data-log-delete-produk">
                  <i class="fas fa-book"></i>
                  <p>data_log_delete_produk </p>
                </a>
              </li>
               <li class="nav-item">
                <a href="data-produk-terbanyak">
                  <i class="fas fa-book"></i>
                  <p>data-produk-terbanyak </p>
                </a>
              </li>
              <li class="nav-item">
                <a href="data-produk-sedikit">
                  <i class="fas fa-book"></i>
                  <p>data-produk-sedikit </p>
                </a>
              </li>
              <li class="nav-item">
      ...
      <div class="main-panel">
        ...
        <?php 
          if (isset($_GET['x'])) {
              ...
              } elseif ($_GET['x'] == "data-produk-terjual") {
                  include 'data_produk_terjual.php';
              ...
              } elseif ($_GET['x'] == "data-produk-terbanyak") {
                  include 'data_produk_terbanyak.php';
              } elseif ($_GET['x'] == "data-produk-sedikit") {
                  include 'data_produk_sedikit.php';
              } elseif ($_GET['x'] == "data") {
                  include 'data.php';
